...
if __name__ == '__main__':
    batch_size = 32
    num_classes = 10
    epochs = 1 # for time, better performance with 5
    data_augmentation = True # will trigger Keras ImageDataGenerator
    num_predictions = 20 # number of preditions to display
    save_dir = os.path.join(os.getcwd(), 'saved_models')
    model_name = 'keras_cifar10_trained_model.h5' # where to save model
    gd_optimizer = RMSprop(lr=0.0001, decay=1e-6)
