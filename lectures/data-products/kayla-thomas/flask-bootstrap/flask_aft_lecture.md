...
It should be about 5 MB zipped archive that uncompresses to about 11 MB into a directory called `Bootstrap-4.0.0`. It's going to contain the files needed to recreate and then customize our own web page.
