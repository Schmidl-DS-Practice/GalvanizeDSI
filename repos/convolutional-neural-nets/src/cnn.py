...
def load_and_featurize_data():
    ...
    # print('this is y_train, before to_categorical**********', y_train, '\n')
    # print('this is Y_train, after to_categorical************', Y_train, '\n')
    # Y_test = to_categorical(y_test, nb_classes)
    # print('thi is y_test before to_categorical*********', y_test, '\n')
    # print('this is Y_test after to_categorical**************', Y_test)
